...
function serialize (obj) {
  ...
  if (typeof afterSerialization === 'function') {
    res = afterSerialization(res);
  }
...
function deserialize (rawData) {
  ...
  if (typeof beforeDeserialization === 'function') {
      rawData = beforeDeserialization(rawData);
  }
...
module.exports.setSerializationOptions = setSerializationOptions;
