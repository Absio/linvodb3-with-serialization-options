...
Added possibility to add callbacks into options, which will be called before returning value from serialize and before deserialize functions.
This functionality can be achieved through passing additional properties into Model options:
   beforeDeserialization: function(rawData) -> should return utf-8 string
   afterSerialization: function(serializedDocument) -> should return stringified value.
